  ...
  return (
    <div className="bg-white w-[85vw] lg:w-auto px-10 rounded-xl m-5 p-4">
      <div className="flex items-center justify-between">
        <p className="text-xl font-medium">Last Orders</p>
        ...
        <table className="table">
          ...
          {LastOrdersData.map((item, index) => (
              <tr key={index}>
                ...
                <td><p className=" text-lg font-normal text-gray-500">{item.date}</p></td>
                <td><p className=" text-lg font-medium ">${item.Amount}</p></td>
                <td ><p className=" text-base font-medium " style={{color:(item.color)}}>{item.Status}</p></td>
                <td className=" flex items-center gap-2">
                  <svg
                  ...
                  <p className=" text-base font-normal ">Views</p>
                </td>
              </tr>
            )
          )}
