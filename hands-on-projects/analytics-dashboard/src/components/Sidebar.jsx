...
const sidebarData = [
  {
    logo: "../assets/Group3.svg",
  },
  {
    logo: "../assets/Group4.svg",
  },
];
      ...
      <div className="drawer lg:drawer-open">
        ...
        <div className="drawer-content bg-sidebar ">
          <div className=" flex items-center ">
            <label
              htmlFor="my-drawer-2"
              className=" cursor-pointer drawer-button pl-3 lg:hidden"
            >
              <svg
            ...
            <div className=" flex flex-col items-center lg:items-start ">{children}</div>
        </div>
        <div className="drawer-side ">
          ...
          ></label>
          <ul className="menu bg-sidebar border-2 border-sidebar-border py-[10px] gap-14 w-[80px] flex flex-col min-h-full text-base-content">
            ...
            <div className=" flex flex-col ">
              ...
              <div className=" bg-white cursor-pointer w-12 justify-center flex flex-col rounded-[100px] gap-[8px] items-center py-[8px]">
                <div className=" w-[30px] h-[30px] bg-green rounded-full items-center flex place-content-center">
                  <li>
                    <a>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
